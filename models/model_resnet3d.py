...
def get_model(input_shape, classes, base_dir="", save_model=True):
    ...
    model = Resnet3DBuilder.build_resnet_18(input_shape, len(classes))
    model.summary()
    ...
    #     print("Layer " + l.name + " Input: " + str(l.input_shape) + " Output: " + str(l.output_shape))
...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        # Minimum size for resnet is 197x197x197. Lets see if zero padding would work
        # model.add(ZeroPadding2D((133, 133), input_shape=(64, 64, num_channels)))
        # input = ZeroPadding3D(padding=(67, 67, 67), data_format="channels_last")(input)

        # print("INPUT SHAPE :: ", input.shape)

        conv1 = _conv_bn_relu3D(filters=64, kernel_size=(7, 7, 7),  # (7, 7, 7)
                                strides=(1, 1, 1),  # (2, 2, 2)
        ...
        # average poll and candidate_classifier
